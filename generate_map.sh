...
wget -O oulu.osm "http://overpass.osm.rambler.ru/cgi/xapi_meta?*[bbox=24.4 ,64.6,26.5,65.33]"
#wget -O oulu.osm "http://www.overpass-api.de/api/xapi_meta?*[bbox=24.4 ,64.6,26.5,65.33]"
